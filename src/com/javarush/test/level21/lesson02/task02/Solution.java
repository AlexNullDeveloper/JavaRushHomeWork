...
//        byte specificModifier1 = (byte) specificModifier;
//        int allModifiers1 = (byte) allModifiers;
//        int i = allModifiers1 & specificModifier1;
        int i = allModifiers & specificModifier;
        if (i == specificModifier) {
            return true;
        } else {
            return false;
        }
